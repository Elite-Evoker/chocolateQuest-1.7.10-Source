...
public class GuiScrollFiles extends GuiScrollOptions
{
    ...
    public GuiScrollFiles(final int id, final int posX, final int posY, final int width, final int height, final File file, final FontRenderer font) {
        this(id, posX, posY, width, height, file, font, 4);
    }
    
    public GuiScrollFiles(final int id, final int posX, final int posY, final int width, final int height, final File file, final FontRenderer font, final int values) {
